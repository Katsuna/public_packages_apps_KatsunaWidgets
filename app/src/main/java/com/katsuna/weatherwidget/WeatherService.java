...
//        boolean darkTheme = theme == R.style.AppTheme ||
...
//        progressDialog = new ProgressDialog(WeatherService.this);
//
//
//        destroyed = false;
//
...
////            try {
////                locationManager.removeUpdates(WidgetActivity.this);
...
//        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(WidgetActivity.this);
//
//        String lastToday = sp.getString("lastToday", "");
//        if (!lastToday.isEmpty()) {
//            new WidgetActivity.TodayWeatherTask(this, this, progressDialog).execute("cachedResponse", lastToday);
//        }
//        String lastLongterm = sp.getString("lastLongterm", "");
//        if (!lastLongterm.isEmpty()) {
//            new WidgetActivity.LongTermWeatherTask(this, this, progressDialog).execute("cachedResponse", lastLongterm);
//        }
//    }
//
//    private void getTodayWeather() {
//        new WidgetActivity.TodayWeatherTask(this, this, progressDialog).execute();
//    }
//
//    private void getLongTermWeather() {
//        new WidgetActivity.LongTermWeatherTask(this, this, progressDialog).execute();
//    }
//
...
//        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(WidgetActivity.this);
//        recentCity = preferences.getString("city", "Athens");
//
...
//        String accentColor = String.format("#%06X", (0xFFFFFF & ta.getColor(0, Color.BLUE)));
//        ta.recycle();
...
//
//            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(WidgetActivity.this).edit();
...
//        new WidgetActivity.ProvideCityNameTask(this, this, progressDialog).execute("coords", Double.toString(latitude), Double.toString(longitude));
//    }
//
//    @Override
...
//        public TodayWeatherTask(Context context, WidgetActivity activity, ProgressDialog progressDialog) {
...
//        public LongTermWeatherTask(Context context, WidgetActivity activity, ProgressDialog progressDialog) {
//            super(context, activity, progressDialog);
//        }
//
//        @Override
...
//
//        public ProvideCityNameTask(Context context, WidgetActivity activity, ProgressDialog progressDialog) {
//            super(context, activity, progressDialog);
//        }
//
//        @Override
